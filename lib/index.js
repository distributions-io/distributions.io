...
/*
dist.norm.pdf = require( 'distributions-norm-pdf' );
dist.norm.cdf = require( 'distributions-norm-cdf' );
dist.norm.quantile = require( 'distributions-norm-quantile' );
dist.norm.mgf = require( 'distributions-norm-mgf' );

dist.norm.random = require( 'distributions-norm-random' );

dist.norm.mean = require( 'distributions-norm-mean' );
dist.norm.median = require( 'distributions-norm-median' );
dist.norm.variance = require( 'distributions-norm-variance' );
dist.norm.skewness = require( 'distributions-norm-skewness' );
dist.norm.ekurtosis = require( 'distributions-norm-ekurtosis' );
dist.norm.entropy = require( 'distributions-norm-entropy' );
*/
